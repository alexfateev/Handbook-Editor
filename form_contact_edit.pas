...
begin
  if edName_f.DataSource.State=dsInsert then
    edName_f.DataSource.DataSet.FieldByName('cont_date_create').AsDateTime:=Now;
  edName_f.DataSource.DataSet.FieldByName('cont_unit').AsString:=edUnit.Value;
  edName_f.DataSource.DataSet.FieldByName('cont_date_change').AsDateTime:=Now;
