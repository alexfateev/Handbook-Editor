...
type
  TfmFeedbackInsert = class(TForm)
    ...
    Label12: TLabel;
    Label13: TLabel;
    edName_save_curr: TRzDBComboBox;
    ...
    procedure edName_save_currDropDown(Sender: TObject);
...
procedure TfmFeedbackInsert.edName_save_currDropDown(Sender: TObject);
begin
  (Sender as TRzDBComboBox).Items.Clear;
  (Sender as TRzDBComboBox).Items.BeginUpdate;
  (Sender as TRzDBComboBox).Add(
    GetContactNameSave(1,edName_f_curr.Text,edName_i_curr.Text,edName_o_curr.Text,edProf_curr.Text));
  (Sender as TRzDBComboBox).Add(
    GetContactNameSave(2,edName_f_curr.Text,edName_i_curr.Text,edName_o_curr.Text,edProf_curr.Text));
  (Sender as TRzDBComboBox).Add(
    GetContactNameSave(3,edName_f_curr.Text,edName_i_curr.Text,edName_o_curr.Text,edProf_curr.Text));
  (Sender as TRzDBComboBox).Add(
    GetContactNameSave(4,edName_f_curr.Text,edName_i_curr.Text,edName_o_curr.Text,edProf_curr.Text));
  (Sender as TRzDBComboBox).Items.EndUpdate;
end;

procedure TfmFeedbackInsert.edUnitChange(Sender: TObject);
begin
  if DSF.DataSet.State<>dsEdit then
    DSF.DataSet.Edit;
  DSF.DataSet.FieldByName('feed_cont_unit').AsString:=(Sender as TRzComboBox).Value;
end;
